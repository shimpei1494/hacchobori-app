    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <Card className="border-2">
        <CardHeader>
          ...
          <CardDescription>レストランの基本的な情報を入力してください</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {/* 店名 */}
          <div className="space-y-2">
            <Label htmlFor={`${formId}-name`} className="flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor={`${formId}-priceMin`} className="flex items-center gap-2">
            ...
            <div className="space-y-2">
              <Label htmlFor={`${formId}-priceMax`} className="flex items-center gap-2">
                <DollarSign className="h-4 w-4" />
                最高価格（円）
              </Label>
              <Input
      ...
      <Card className="border-2">
        ...
        <CardContent className="space-y-4">
          {/* 距離 */}
          <div className="space-y-2">
            <Label htmlFor={`${formId}-distance`} className="flex items-center gap-2">
      ...
      <Card className="border-2">
        ...
        <CardContent className="space-y-4">
          {/* 食べログURL */}
          <div className="space-y-2">
            <Label htmlFor={`${formId}-tabelogUrl`} className="flex items-center gap-2">
            ...
            />
            {errors.tabelogUrl && <p className="text-sm text-red-500">{errors.tabelogUrl.message}</p>}
          </div>

          {/* WebサイトURL */}
          <div className="space-y-2">
            <Label htmlFor={`${formId}-websiteUrl`} className="flex items-center gap-2">
              <Globe className="h-4 w-4" />
              WebサイトURL
            </Label>
            <Input
      ...
      <Card className="border-2">
        ...
        <CardContent>
          <div className="space-y-2">
            <Label htmlFor={`${formId}-description`} className="flex items-center gap-2">
